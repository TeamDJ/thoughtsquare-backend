  ...
  def create
    ...
    respond_to do |format|
      if @user_location.save
        format.html { redirect_to(@user_location, :notice => 'UserLocation was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @user_location.update_attributes(params[:user_location])
        format.html { redirect_to(@user_location, :notice => 'UserLocation was successfully updated.') }
        format.xml  { head :ok }
        format.json { head :ok }
      else
